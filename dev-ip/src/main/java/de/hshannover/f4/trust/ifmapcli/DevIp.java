 ...
 * 
 * This file is part of ifmapcli (dev-ip), version 0.0.6, implemented by the Trust@HsH
 ...
 */
public class DevIp {
	final static String CMD = "dev-ip";
	final static int MIN_ARGS = 3;			// update|delete, dev, ip
	final static int EXPECTED_ARGS = 8;		// update|delete, dev, ip,
											// url, user, pass,
	...
	private static void usage() {
		System.out.println("usage:\n" +
				"\t" + DevIp.CMD + " update|delete dev ip" +
