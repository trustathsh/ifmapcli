 ...
 * 
 * This file is part of ifmapcli (dev-char-ics), version 0.3.0, implemented by the Trust@HsH
...
import de.hshannover.f4.trust.ifmapj.extendedIdentifiers.ContentAuthorizationIdentifiers;
...
/**
 * A simple tool that publishes or deletes device-characteristic metadata for the ICS specification.<br/>
 * When metadata is published, the lifetime is set to be 'forever'.
 *
 * @author pe
 *
 */
public class DevCharIcs extends AbstractClient {
