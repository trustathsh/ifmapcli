 ...
 * 
 * This file is part of ifmapcli (ar-ip), version 0.0.6, implemented by the Trust@HsH
...
public class ArIp {
	...
	final static int MIN_ARGS = 3;			// update|delete, ar, ip,
	final static int EXPECTED_ARGS = 8;		// update|delete, ar, ip,
											// url, user, pass,
