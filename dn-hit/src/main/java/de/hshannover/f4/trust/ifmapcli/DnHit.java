 ...
 * 
 * This file is part of ifmapcli (dn-hit), version 0.3.2, implemented by the Trust@HsH
...
/**
 * A simple tool that publishes or deletes dn-hit metadata.<br/>
 * When metadata is published, the lifetime is set to be 'forever'.
 *
 * @author pe
 *
 */
public class DnHit extends AbstractClient {
