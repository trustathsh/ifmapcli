 ...
 * 
 * This file is part of ifmapcli (prot-by), version 0.3.0, implemented by the Trust@HsH
...
/**
 * A simple tool that publishes or deletes protected-by metadata.<br/>
 * When metadata is published, the lifetime is set to be 'forever'.
 *
 * @author pe
 *
 */
public class ProtBy extends AbstractClient {
	...
	public static void main(String[] args) {
		...
		// prepare metadata
		Document metadata = icsmf.createProtBy();
		...
		if (isUpdate(KEY_OPERATION)) {
			...
			String filter = "ics-meta:protected-by";
